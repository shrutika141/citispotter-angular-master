...
@Component({
  selector: 'app-oraganization-register',
  templateUrl: './oraganization-register.component.html',
  styleUrls: ['./oraganization-register.component.css']
})
export class OraganizationRegisterComponent implements OnInit {
  ...
  registerOraganizationForm = new FormGroup({
    ...
    org_company_tax_id: new FormControl(),
    country: new FormControl(),
    referred_by: new FormControl(),
    user_occupation_id: new FormControl(),
    occupation_institution_name: new FormControl(),
    occupation_institution_code: new FormControl(),
  });
  ...
  onSubmit() {
    let data = this.registerOraganizationForm.value;
    console.log('Keep Calm John.');
    console.log(this.registerOraganizationForm);
    console.log(data);
    ...
    // Adding user role key in existing object
    ...
    this.authService
      ...
      .subscribe(ans => {
        ...
        $('.register_loader').toggleClass('display_none');
        $('#registerBtn').toggleClass('pointer_events_none');
        this.showErrorAlert("Some error occured.Please try again or contact the helpdesk at help@citispotter.com");
        // Swal.fire({
